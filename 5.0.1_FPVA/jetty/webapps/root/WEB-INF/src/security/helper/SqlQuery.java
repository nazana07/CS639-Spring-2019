...
/**
 * This is a helper class to make using sql easier. It should be used whenever
...
public class SqlQuery {
    ...
    /*
     * (non-Javadoc) Method for querying the database. Simply takes the query as is
     * from the caller and executes it and returns the result.
     *
     ...
     *
     * @param values - values to fill the query string in with in a Prepared
     * Statement.
     *
     * @return void
     */
